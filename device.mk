...
PRODUCT_COPY_FILES += \
   ...
   device/lge/tiger6/init.lge.power.rc:root/init.lge.power.rc \
   device/lge/tiger6/init.lge.usb.rc:root/init.lge.usb.rc \
   device/lge/tiger6/init.lge.usb.sh:root/init.lge.usb.sh \
   device/lge/tiger6/init.mdm.sh:root/init.mdm.sh \
   device/lge/tiger6/init.qcom.class_core.sh:root/init.qcom.class_core.sh \
   device/lge/tiger6/init.qcom.early_boot.sh:root/init.qcom.early_boot.sh \
   device/lge/tiger6/init.qcom.factory.sh:root/init.qcom.factory.sh \
   device/lge/tiger6/init.qcom.rc:root/init.qcom.rc \
   device/lge/tiger6/init.qcom.sh:root/init.qcom.sh \
   device/lge/tiger6/init.qcom.ssr.sh:root/init.qcom.ssr.sh \
   device/lge/tiger6/init.qcom.syspart_fixup.sh:root/init.qcom.syspart_fixup.sh \
   device/lge/tiger6/init.tiger6_core.rc:root/init.tiger6_core.rc \
   device/lge/tiger6/init.tiger6_product.rc:root/init.tiger6_product.rc \
   device/lge/tiger6/init.tiger6.rc:root/init.tiger6.rc \
   device/lge/tiger6/init.usb.rc:root/init.usb.rc \
   device/lge/tiger6/set_emmc_size.sh:root/set_emmc_size.sh \
   device/lge/tiger6/ueventd.rc:root/ueventd.rc \
...
#   $(LOCAL_PATH)/idc/qwerty.idcc:system/usr/idc/qwerty.idc \
#    $(LOCAL_PATH)/idc/qwerty2.idc:system/usr/idc/qwerty2.idc

PRODUCT_COPY_FILES += \
    device/lge/tiger6/conf/audio_policy.conf:system/etc/audio_policy.conf \
    device/lge/tiger6/conf/mixer_paths.xml:system/etc/mixer_paths.xml \
    device/lge/tiger6/conf/audio_effects.conf:system/vendor/etc/audio_effects.conf
...
# For GPS
PRODUCT_COPY_FILES += \
    device/lge/tiger6/conf/sec_config:system/etc/sec_config
...
# For SPN display
PRODUCT_COPY_FILES += \
    device/lge/tiger6/conf/spn-conf.xml:system/etc/spn-conf.xml
...
# GPS configuration
PRODUCT_COPY_FILES += \
    device/lge/tiger6/conf/gps.conf:system/etc/gps.conf
